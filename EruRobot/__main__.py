...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[Hey I am Alive Now!!]()", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
    ...
    if WEBHOOK:
        ...
        LOGGER.info(f"Eru is started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
