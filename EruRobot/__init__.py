...
def get_user_list(__init__, key):
    with open("{}/EruRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[EruRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[EruRobot]')
LOGGER.info("EruRobot is starting. | An academy official Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/baby-kun (t.me/baby_hoii)")
...
if ENV:
    ...
    from EruRobot.config import Development as Config
...
from EruRobot.modules.helper_funcs.handlers import (
