...
from EruRobot import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./EruRobot/resources/fonts/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="here is your logo! made by [Eru Robot](https://t.me/eruxrobot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./EruRobot/resources/fonts"):
            os.remove(font_)
...
async def logo_(event):
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="here is your wlogo! made by  [Eru Robot](https://t.me/eruxrobot)",
            force_document=False,
        )
        os.remove(flnme)
        await xx.delete()
