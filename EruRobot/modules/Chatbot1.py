...
import html
import requests
import EruRobot.modules.sql.chatbot_sql as sql
...
from EruRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from EruRobot import dispatcher, updater, SUPPORT_CHAT
from EruRobot.modules.log_channel import gloggable
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Chitta ai activated by {}.".format(mention_html(user.id, user.first_name)),
...
def kuki(update: Update, context: CallbackContext):
    ...
    msg = "Choose an option to access eru's ai"
